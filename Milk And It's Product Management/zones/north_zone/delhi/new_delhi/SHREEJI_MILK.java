package zones.north_zone.delhi.new_delhi;
import zones.*;
import java.io.*;
public class SHREEJI_MILK implements call_cmpny
{
    public void prdcts() throws IOException
    {
        ...
        System.out.print("\n                         SHREEJI MILK                            ");
        System.out.print("\n_________________________________________________________________");
        System.out.println("\n\nWelcome to SHREEJI MILK. Select your choice.");
        System.out.println("\n\n[1]--> MILK");
        System.out.print("\n[2]--> CURD");
        System.out.print("\n[3]--> BUTTER");
        System.out.print("\n[4]--> PANEER");
    ...
    catch (Exception e)
{
    ...
    SHREEJI_MILK a=new SHREEJI_MILK();
    a.prdcts();
}
                ...
                System.out.println("\f");
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> TOND  MILK <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 2 lakh liters");
                System.out.println("\n\n# FAT = 3.5%");
                System.out.println("\n\n# PHONE NUMBER = 02110243827/22/23");
        double n1;
        try{
        System.out.println("\n\n# COST PER LITER = Rs.32.50/-");
        System.out.println("\n\n# DISCOUNT = 15%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
        String sc=br.readLine();
        if(sc.equals("0"))
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                SHREEJI_MILK oi=new SHREEJI_MILK();
                oi.prdcts();
            }
        } catch (Exception e1)
        {
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\f");
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> LASSI <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 9000 LITER");
                System.out.println("\n\n# FAT = 4.5%");
                System.out.println("\n\n# PHONE NUMBER = 02110243827/22/23");
        double n10;
        try{
        System.out.println("\n\n# COST PER LITER = Rs.70/-");
        System.out.println("\n\n# DISCOUNT = 15%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
        String sc=br.readLine();
        if(sc.equals("0"))
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\f");
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> GHEE <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 500KG");
                System.out.println("\n\n# FAT = 80%");
                System.out.println("\n\n# PHONE NUMBER = 02110243827/22/23");
        double n7;
        try{
        System.out.println("\n\n# COST PER 500g = Rs.205/-");
        System.out.println("\n\n# DISCOUNT = 20%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
        String sc=br.readLine();
        if(sc.equals("0"))
    ...
    a.prdcts();
        ...
        try{
            ...
            switch(j)
            {
                ...
                System.out.println("\n\n# FAT = 38%");
                System.out.println("\n\n# PHONE NUMBER = 02118213827/22/23");
                double n9;
                try{
                    System.out.println("\n\n# COST FOR 500g = Rs.249/-");
                    System.out.println("\n\n# DISCOUNT = 10%");
                    System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
                    String sc=br.readLine();
                    if(sc.equals("0"))
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\f");
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> GOUDA <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 900Kg");
                System.out.println("\n\n# FAT = 40%");
                System.out.println("\n\n# PHONE NUMBER = 02110243827/22/23");
        double n11;
        try{
        System.out.println("\n\n# COST FOR 500g = Rs.262/-");
        System.out.println("\n\n# DISCOUNT = 20%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
        String sc=br.readLine();
        if(sc.equals("0"))
