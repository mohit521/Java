    ...
    public void prdcts() throws IOException
    {
        ...
        switch(k)
        {
            ...
            switch(j)
            {
                ...
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> DOUBLE  TOND  MILK <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 20 lakh liters");
                System.out.println("\n\n# FAT = 1.5%");
                System.out.println("\n\n# PHONE NUMBER = 02110243827/22/23");
                double n;
                try{
                    System.out.println("\n\n# COST PER LITER = Rs.30/-");
                    System.out.println("\n\n# DISCOUNT = 10%");
                    System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\f");
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> FULL CREAM  MILK <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 18 lakh liters");
                System.out.println("\n\n# FAT = 6%");
                System.out.println("\n\n# PHONE NUMBER = 02110243827/22/23");
        double n2;
        try{
        System.out.println("\n\n# COST PER LITER = Rs.38/-");
        System.out.println("\n\n# DISCOUNT = 20%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
        String sc=br.readLine();
        if(sc.equals("0"))
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\f");
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> CHEDDAR <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 750Kg");
                System.out.println("\n\n# FAT = 40%");
                System.out.println("\n\n# PHONE NUMBER = 02110246667/22/23");
        double n10;
        try{
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 900Kg");
                System.out.println("\n\n# FAT = 40%");
                System.out.println("\n\n# PHONE NUMBER = 02110241827/22/23");
        double n11;
        try{
