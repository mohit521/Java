package zones.north_zone.uttar_pradesh.kanpur;
import zones.*;
import java.io.*;
public class SUDHA implements call_cmpny
{
    public void prdcts() throws IOException
    {
        ...
        System.out.print("\n                            SUDHA                                ");
        System.out.print("\n_________________________________________________________________");
        System.out.println("\n\nWelcome to SUDHA. Select your choice.");
        System.out.println("\n\n[1]--> MILK");
        System.out.print("\n[2]--> CURD");
        System.out.print("\n[3]--> BUTTER");
        System.out.print("\n[4]--> PANEER");
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n# FAT = 3.5%");
                System.out.println("\n\n# PHONE NUMBER = 06378374827/22/23");
        double n1;
        try{
