    ...
    public void prdcts() throws IOException
    {
        ...
        switch(k)
        {
            ...
            switch(j)
            {
                ...
                System.out.println("\n\n# FAT = 1.5%");
                System.out.println("\n\n# PHONE NUMBER = 51760243827/22/23");
                double n;
                try{
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n# FAT = 6%");
                System.out.println("\n\n# PHONE NUMBER = 453266718237/22/23");
        double n2;
        try{
    ...
    a.prdcts();
        ...
        try{
            ...
            switch(l)
            {
                ...
                System.out.println("\n\n# FAT = 4.5%");
                System.out.println("\n\n# PHONE NUMBER = 122133343827/22/23");
        double n3;
        try{
        System.out.println("\n\n# COST PER 500g = Rs.70/-");
        System.out.println("\n\n# DISCOUNT = 15%");
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 1000Kg");
                System.out.println("\n\n# FAT = 7%%");
                System.out.println("\n\n# PHONE NUMBER = 87653453827/22/23");
        double n4;
        try{
        System.out.println("\n\n# COST PER 500g = Rs.85/-");
        System.out.println("\n\n# DISCOUNT = 20%");
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 150Kg");
                System.out.println("\n\n# FAT = 80%");
                System.out.println("\n\n# PHONE NUMBER = 378900243827/22/23");
        double n6;
        try{
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n# FAT = 80%");
                System.out.println("\n\n# PHONE NUMBER = 53464243827/22/23");
        double n7;
        try{
    ...
    a.prdcts();
        ...
        try{
            ...
            switch(j)
            {
                ...
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 1000Kg");
                System.out.println("\n\n# FAT = 38%");
                System.out.println("\n\n# PHONE NUMBER = 17110243827/22/23");
                double n9;
                try{
