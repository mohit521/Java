package zones.west_zone.maharashtra.pune;
import zones.*;
import java.io.*;
public class SURUCHI_DAIRY implements call_cmpny
{
    public void prdcts() throws IOException
    {
        ...
        System.out.print("\n                         SURUCHI DAIRY                            ");
        System.out.print("\n_________________________________________________________________");
        System.out.println("\n\nWelcome to SURUCHI DAIRY. Select your choice.");
        System.out.println("\n\n[1]--> MILK");
        System.out.print("\n[2]--> CURD");
        System.out.print("\n[3]--> BUTTER");
        System.out.print("\n[4]--> PANEER");
    ...
    catch (Exception e)
{
    ...
    SURUCHI_DAIRY a=new SURUCHI_DAIRY();
    a.prdcts();
}
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                SURUCHI_DAIRY oi=new SURUCHI_DAIRY();
                oi.prdcts();
            }
        } catch (Exception e1)
        {
