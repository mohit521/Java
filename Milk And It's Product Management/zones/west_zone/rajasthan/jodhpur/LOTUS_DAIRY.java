package zones.west_zone.rajasthan.jodhpur;
import zones.*;
import java.io.*;
public class LOTUS_DAIRY implements call_cmpny
{
    public void prdcts() throws IOException
    {
        ...
        System.out.print("\n                         LOTUS DAIRY                            ");
        System.out.print("\n_________________________________________________________________");
        System.out.println("\n\nWelcome to LOTUS DAIRY. Select your choice.");
        System.out.println("\n\n[1]--> MILK");
        System.out.print("\n[2]--> CURD");
        System.out.print("\n[3]--> BUTTER");
        System.out.print("\n[4]--> PANEER");
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                LOTUS_DAIRY oi=new LOTUS_DAIRY();
                oi.prdcts();
            }
        } catch (Exception e1)
        {
