...
import zones.*;
import java.io.*;
public class INDIAN_DAIRY implements call_cmpny
{
    public void prdcts() throws IOException
    {
        ...
        System.out.print("\n                          INDIAN DAIRY                          ");
        System.out.print("\n_________________________________________________________________");
        System.out.println("\n\nWelcome to INDIAN DAIRY. Select your choice.");
        System.out.println("\n\n[1]--> MILK");
        System.out.print("\n[2]--> CURD");
        System.out.print("\n[3]--> BUTTER");
        System.out.print("\n[4]--> PANEER\n");
    ...
    catch (Exception e)
{
    ...
    INDIAN_DAIRY a=new INDIAN_DAIRY();
    a.prdcts();
}
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                INDIAN_DAIRY oi=new INDIAN_DAIRY();
                oi.prdcts();
            }
        }catch (Exception e1)
        {
