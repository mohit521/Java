package zones.east_zone.west_bengal.asansol;
import zones.*;
import java.io.*;
public class DELIGHT_DAIRY implements call_cmpny
{
    public void prdcts() throws IOException
    {
        ...
        System.out.print("\n                         DELIGHT DAIRY                           ");
        System.out.print("\n_________________________________________________________________");
        System.out.println("\n\nWelcome to DELIGHT DAIRY. Select your choice.");
        System.out.println("\n\n[1]--> MILK");
        System.out.print("\n[2]--> CURD");
        System.out.print("\n[3]--> BUTTER");
        System.out.print("\n[4]--> PANEER\n");
        ...
        switch(k)
        {
            ...
            switch(j)
            {
                ...
                System.out.println("\n\n# FAT = 1.5%");
                System.out.println("\n\n# PHONE NUMBER = 31228343827/22/23");
        double n;
        try{
        System.out.println("\n\n# COST PER LITER = Rs.33.50/-");
        System.out.println("\n\n# DISCOUNT = 10%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
    ...
    catch (Exception e)
{
    ...
    DELIGHT_DAIRY a=new DELIGHT_DAIRY();
    a.prdcts();
}
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\f");
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> POWDER  MILK <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 1000 Kg");
                System.out.println("\n\n# FAT = 1.5%");
                System.out.println("\n\n# PHONE NUMBER = 2376243827/22/23");
        double n9;
        try{
        System.out.println("\n\n# COST PER Kg = Rs.330/-");
        System.out.println("\n\n# DISCOUNT = 10%");
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                DELIGHT_DAIRY oi=new DELIGHT_DAIRY();
                oi.prdcts();
            }
        }catch (Exception e1)
        {
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 1000Kg");
                System.out.println("\n\n# FAT = 7%%");
                System.out.println("\n\n# PHONE NUMBER = 12340243827/22/23");
        double n4;
        try{
        System.out.println("\n\n# COST PER 500g = Rs.105/-");
        System.out.println("\n\n# DISCOUNT = 20%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
        String sc=br.readLine();
        if(sc.equals("0"))
    ...
    a.prdcts();
        ...
        try{
            ...
            switch(m)
            {
                ...
                System.out.println("\n\n# FAT = 80%");
                System.out.println("\n\n# PHONE NUMBER = 32710243827/22/23");
        double n5;
        try{
        System.out.println("\n\n# COST PER 500g = Rs.180/-");
        System.out.println("\n\n# DISCOUNT = 20%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
        String sc=br.readLine();
        if(sc.equals("0"))
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 150Kg");
                System.out.println("\n\n# FAT = 80%");
                System.out.println("\n\n# PHONE NUMBER = 87110243827/22/23");
        double n6;
        try{
        System.out.println("\n\n# COST PER 500g = Rs.173/-");
        System.out.println("\n\n# DISCOUNT = 20%");
        System.out.println("\n\nPRESS 0 TO PROCEED\n    OR\nPRESS * TO GO BACK");
        String sc=br.readLine();
        if(sc.equals("0"))
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\n\n# FAT = 80%");
                System.out.println("\n\n# PHONE NUMBER = 15270243827/22/23");
        double n7;
        try{
