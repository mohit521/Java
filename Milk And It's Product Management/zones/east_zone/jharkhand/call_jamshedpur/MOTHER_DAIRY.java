...
import zones.*;
import java.io.*;
public class MOTHER_DAIRY implements call_cmpny
{
    public void prdcts() throws IOException
    {
        ...
        System.out.print("\n                         MOTHER DAIRY                            ");
        System.out.print("\n_________________________________________________________________");
        System.out.println("\n\nWelcome to MOTHER DAIRY. Select your choice.");
        System.out.println("\n\n[1]--> MILK");
        System.out.print("\n[2]--> CURD");
        System.out.print("\n[3]--> BUTTER");
        System.out.print("\n[4]--> PANEER");
    ...
    catch (Exception e)
{
    ...
    MOTHER_DAIRY a=new MOTHER_DAIRY();
    a.prdcts();
}
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                MOTHER_DAIRY oi=new MOTHER_DAIRY();
                oi.prdcts();
            }
        } catch (Exception e1)
        {
    ...
    catch (Exception e)
{
    ...
    a.prdcts();
                ...
                System.out.println("\f");
                System.out.println("\n>>>>>>>>>>>>>>>>>>>> LASSI <<<<<<<<<<<<<<<<<<<<");
                System.out.println("\n\n\n\n# PRODUCTION PER DAY = 10000 LITER");
                System.out.println("\n\n# FAT = 4.5%");
                System.out.println("\n\n# PHONE NUMBER = 02110243827/22/23");
        double n10;
        try{
